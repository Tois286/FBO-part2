                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"><i class="bi bi-file-pdf"></i>Upload</h3></div>
                                    <div class="card-body">
                                      ...
                                      <div class="card-footer text-center">
                                        <div class="small"><a href="index2.php">Kembali</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
