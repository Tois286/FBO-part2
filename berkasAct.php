...
<div class="container">
  <div class="row">
     ...
     <h1 class="display-2 text-center mb-3"><i class="bi bi-file-pdf"></i> Pdf Book</h1> 
          <a href="halaman_upload.php"><button type="button" class="btn btn-danger  mb-3"><i class="bi bi--circle"></i>Kembali</button></a>
          <a href="index2.php"><button type="button" class="btn btn-primary  mb-3"><i class="bi bi--circle"></i>lanjut</button></a>
           <!-- Table -->
